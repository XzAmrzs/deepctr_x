...
# os.environ["PATH"] += os.pathsep + r"C:\Program Files\Graphviz\bin"  # 注意修改你的路径
...
if __name__ == "__main__":
    ...
    # keras.utils.plot_model(history, "my_first_model.png")
    # keras.utils.plot_model(history, "my_first_model_with_shape_info.png", show_shapes=True)
